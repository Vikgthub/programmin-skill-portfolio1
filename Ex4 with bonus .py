...
if a1 == France:
    ...
    print ("wrong answer!!! Correct ans = Paris")
...
if b1 == Germany:
    ...
    print ("wrong answer!!! Correct ans = Berlin")
...
if c1 == Italy:
    ...
    print ("wrong answer!!! Correct ans = Rome")
...
if d1 == Spain:
    ...
    print ("wrong answer!!! Correct ans = Madrid")
...
if e1 == Norway:
    ...
    print ("wrong answer!!! Correct ans = Oslo" )
...
if f1 == Netherlands:
    ...
    print ("wrong answer!!! Correct ans = Amsterdam")
...
if g1 == Austria:
    ...
    print ("wrong answer!!! Correct ans = Vienna")
...
if h1 == Romania:
    ...
    print ("wrong answer!!! Correct ans = Bucharest")
...
if i1 == Iceland:
    ...
    print ("wrong answer!!! Correct ans = Reykjavik")
...
if j1 == Slovenia:
    ...
    print ("wrong answer!!! Correct ans = Ljubljana")
